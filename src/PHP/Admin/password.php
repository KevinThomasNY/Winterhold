...
$query_courses = 'select * from forgot_pw 
inner join login on login.email = forgot_pw.email_reset
inner join user on user.user_id = login.user_id';
...
<body>
    ...
    <div class="h-full ml-14 mt-14 mb-10 md:ml-64 ">
        ...
        <span class="ml-8 bg-blue-100 text-blue-800 text-lg font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">Users in this table need their password reset</span>
                    ...
                    <div class="overflow-hidden shadow-md sm:rounded-lg">
                        <table class="min-w-full">
                            ...
                            <tbody> <?php foreach ($courses as $course) : ?> <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50">
                                    ...
                                    <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white"><?php echo $course['email_reset']; ?> </td>
