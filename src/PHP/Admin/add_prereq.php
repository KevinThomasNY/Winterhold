...
$prereq_id = trim($_GET['id']);
$course_id = trim($_GET['course_id']);
try {
    $query = "insert into prerequite (course_id,prereq_id,minimum_grade) values ('$course_id','$prereq_id','C');";
...
?> <script type="text/javascript">
    let timerInterval
    Swal.fire({
        title: 'Prerequisite Added Successfully...',
