        ...
        <ul class="flex flex-col py-4 space-y-1">
            ...
            <!-- <li>
                <button type="button" class="w-full relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                    <span class="inline-flex justify-center items-center ml-4" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                        <svg class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7" />
                        </svg>
                        <span class="ml-2 text-sm tracking-wide truncate" sidebar-toggle-item> All Users</span>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                     <a href="view_all_users.php" class="flex items-center p-2 pl-11 w-full  focus:outline-none hover:bg-blue-800  text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500  pr-6">
                    <span class="ml-2 text-sm tracking-wide truncate">View Users</span></a>       
                  </li>
                    <li>
                     <a href="view_students.php" class="flex items-center p-2 pl-11 w-full  focus:outline-none hover:bg-blue-800  text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500  pr-6">
                    <span class="ml-2 text-sm tracking-wide truncate">View  Students</span></a>       
                  </li>
                    <li>
                     <a href="view_faculty.php" class="flex items-center p-2 pl-11 w-full  focus:outline-none hover:bg-blue-800  text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500  pr-6">
                    <span class="ml-2 text-sm tracking-wide truncate">View Faculty</span></a>       
                  </li>
                    <li>
                     <a href="#" class="flex items-center p-2 pl-11 w-full  focus:outline-none hover:bg-blue-800  text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500  pr-6">
                    <span class="ml-2 text-sm tracking-wide truncate">View All Admins</span></a>       
                  </li>
                    <li>
                     <a href="#" class="flex items-center p-2 pl-11 w-full  focus:outline-none hover:bg-blue-800  text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500  pr-6">
                    <span class="ml-2 text-sm tracking-wide truncate">View Researchers</span></a>       
                  </li>
                </ul>
            </li> -->
            <li>
            ...
            <li>
                <a href="new_course.php" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                    <span class="inline-flex justify-center items-center ml-4">
                        <svg class="h-5 w-5 text-white" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" />
                    ...
                    <span class="ml-2 text-sm tracking-wide truncate">Create New Course</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="view_all_users.php" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                    ...
                    <span class="ml-2 text-sm tracking-wide truncate">All Users</span>
                </a>
            </li>
            <li>
