                        ...
                        <table id="myTable" class="min-w-full">
                            <thead class="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th scope="col" class="py-3 px-6 text-xs font-medium tracking-wider text-left text-gray-700 uppercase dark:text-gray-400">Attendance</th>
                                    ...
                                    <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white"><a class="font-medium text-green-600  hover:underline" href="view_degree_audit.php?id=<?php echo $course['student_id'] ?>&first_name=<?php echo $course['first_name'] ?>">Degree Audit</a> </td>
                                    <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white"><a class="font-medium text-blue-600  hover:underline" href="attendance.php?id=<?php echo $course['student_id'] ?>&first_name=<?php echo $course['first_name'] ?>&crn=<?php echo $course['crn']?>">Attendance</a> </td>
